...
describe("AssociateStateAndPersistencyId", {}, () => {
    it.each([
        ...
        // Traversal context.
        [COMPONENTS_STATE_1, ["page.1", "page.4"], {"persistency.1": {d: 3.14, e: "abc",}, "persistency.2": {c: "Hello world"}, "persistency.5": {c: false}}],
        [COMPONENTS_STATE_1, ["page.4", "page.1"], {"persistency.1": {a: true, b: 5,}, "persistency.2": {c: "Hello world"}, "persistency.5": {c: false}}],

        // Global state mapping.
        [COMPONENTS_STATE_1, undefined, {"persistency.1": {d: 3.14, e: "abc",}, "persistency.2": {c: "Hello world"}, "persistency.4": {d: -91.2, e: "abc"}, "persistency.5": {c: false}}],
